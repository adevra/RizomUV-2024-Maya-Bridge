...
**Version 2.3.0** | **Author:** A. Devran | **GitHub:** [https://github.com/adevra/RizomUV-2024-Maya-Bridge](https://github.com/adevra/RizomUV-2024-Maya-Bridge)
...
## Features
- Easy drag-and-drop installer/uninstaller/updater.
...
#### (if you have previous version installed, please remove it from your /maya/202X/prefs/ folder and remove shelf button)

---

## Usage
- **Send to RizomUV:** Select mesh, click "Send to RizomUV."
- **Auto Pack:** Select mesh, Select a UVSet, click "Auto Pack" to pack UVs in Rizom, Save when packing finishes.
